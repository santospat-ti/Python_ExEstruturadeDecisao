...
print(f'Valores lidos: {n_valores-1}')
...
"""for v in range(0, len(valores_lista)):
    if valores_lista[v] > media:
        print(f'Valores acima da média: {valores_lista[v]}') #valores acima da média
        valor_acima += 1
    if valores_lista[v] < 7:
        print(f'Valores abaixo de sete: {valores_lista[v]}') #abaixo de sete"""
